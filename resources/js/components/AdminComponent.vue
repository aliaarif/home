      ...
      <div class="card">
        <div class="card-content">
          <p class="caption mb-0">
            ...
            language that combines the classic principles of successful design along with1 innovation and
            technology.
          </p>
        </div>
      </div>
...
<ul id="slide-out-chat" class="sidenav slide-out-right-sidenav-chat">
  <li class="center-align pt-2 pb-2 sidenav-close chat-head">
    <a href="{{ asset('#!"><i class="material-icons mr-0">chevron_left</i>Elizabeth Elliott</a>
  </li>
  <li class="chat-body">
    <ul class="collection">
